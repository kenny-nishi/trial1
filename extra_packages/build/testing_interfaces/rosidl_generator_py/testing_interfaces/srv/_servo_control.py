...
class Metaclass_ServoControl_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('testing_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_ServoControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'testing_interfaces.srv.ServoControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from testing_interfaces.srv import _servo_control
...
class ServoControl(metaclass=Metaclass_ServoControl):
    from testing_interfaces.srv._servo_control import ServoControl_Request as Request
    from testing_interfaces.srv._servo_control import ServoControl_Response as Response
